the domain of a [[Function|function]] is the [[Sets|set]] of inputs accepted by the function. it is sometimes denoted by $\text{dom}(f)$ or $\text{dom }f$, where $f$ is a function.
