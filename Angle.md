in [[Geometry|geometry]], an angle is the figure formed by two [[Ray|rays]], called the [[Edge (geometry)|sides]] of the angle, sharing a common endpoint called the [[Vertex (geometry)|vertex]] of the angle.
